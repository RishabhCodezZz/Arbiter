...
**The tally.** 17 real defects were found this way across the project — by actually
running things and trying to break them, never by reading code and deciding it looked
correct — every one logged as it surfaced, every one fixed, none shipped.
